...
UPDATE orientacao SET
    corpo = 'Divida o prato em quatro partes iguais.' || CHAR(10) ||
            'Duas partes de legumes e verduras, cruas ou cozidas.' || CHAR(10) ||
            'Uma parte de arroz, macarrão, batata, mandioca ou pão.' || CHAR(10) ||
...
UPDATE orientacao SET
    ...
    corpo = 'Beba de 30 a 35 ml de água por quilo de peso, distribuídos no dia.' || CHAR(10) ||
            'Deixe uma garrafa à vista: sede não é um bom aviso, ela chega tarde.' || CHAR(10) ||
...
UPDATE orientacao SET
    ...
    corpo = 'Olhe primeiro a lista de ingredientes, e não a tabela nutricional.' || CHAR(10) ||
            'Os ingredientes vêm em ordem de quantidade: o primeiro é o que mais tem.' || CHAR(10) ||
            'Açúcar aparece com muitos nomes — xarope de glicose, dextrose, maltodextrina.' || CHAR(10) ||
...
UPDATE orientacao SET
    ...
    corpo = 'Faça a lista antes de sair e não vá ao mercado com fome.' || CHAR(10) ||
            'Circule pelas bordas do mercado: é onde ficam hortifrúti, carnes e laticínios.' || CHAR(10) ||
            'Deixe legumes lavados e porcionados assim que chegar em casa.'
WHERE conta_id IS NULL AND titulo = 'Organizacao das compras';

UPDATE orientacao SET
    corpo = 'Escolha o prato antes de sentar, olhando o cardápio com calma.' || CHAR(10) ||
            'Peça o molho à parte e prefira grelhado a frito.' || CHAR(10) ||
